  ...
  <nav class="navbar navbar-dark bg-primary sticky-top navbar-expand-lg">
    <div class="container-fluid">
      ...
      <a class="navbar-brand d-flex align-items-center" href="/">
        <img src="/src/assets/TeisMotor.svg" alt="Logo EmpresaTeis" class="brand-logo me-2" />
      </a>
      ...
      >
        <ul class="navbar-nav d-flex justify-content-center w-100">
          ...
          <li class="nav-item" v-if="isAdmin">
            <router-link class="nav-link" to="/gestion-reservas">Gestión Reservas</router-link>
          </li>
          <li class="nav-item">
        ...
        <form class="ms-auto me-3" role="search" @submit.prevent="buscar">
