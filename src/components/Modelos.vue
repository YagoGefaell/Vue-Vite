    ...
    <form @submit.prevent="guardarVehiculo" class="mb-2 mt-1">
      ...
      <div class="row g-3 align-items-center mt-2">
        <div class="col-12 col-md-2 d-flex align-items-center">
          ...
          <input type="text" id="anio" v-model="vehiculo.anio" class="form-control rounded-0 shadow-none border" required>
        </div>

        <div class="col-12 col-md-3">
          <label for="kilometros" class="form-label mb-0 me-3 text-nowrap">Kilómetros:</label>
          <input type="text" id="kilometros" v-model="vehiculo.kilometros" class="form-control rounded-0 shadow-none border" required>
        </div>

        <div class="col-12 col-md-3">
          <label for="precio" class="form-label mb-0 me-3 text-nowrap">Precio (€):</label>
          <input type="text" id="precio" v-model="vehiculo.precio" class="form-control rounded-0 shadow-none border" required>
        </div>
